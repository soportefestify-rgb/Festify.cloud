...
function debugLog(msg) {
  try { console.log('[VERIFY]', msg); } catch (_) {}
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (!window.supabase) {
    ...
    s.onload = function() { debugLog('Supabase JS cargado'); handleVerify(); };
...
function handleVerify() {
  ...
  document.getElementById('status').textContent = 'Procesando enlace de verificación…';
  let supabase;
  try {
